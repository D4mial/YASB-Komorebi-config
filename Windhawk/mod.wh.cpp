...
const Theme g_themeRosePine = {{
    ...
    ThemeTargetStyles{L"Taskbar.TaskListLabeledButtonPanel@CommonStates > Rectangle#RunningIndicator", {
        ...
        L"RadiusY=5",
        L"StrokeThickness=2",
        L"Stroke@InactivePointerOver=#FFFFFF",
        L"Stroke@InactivePressed=#FFFFFF",
        L"Stroke@ActiveNormal=#FFFFFF",
        L"Stroke@ActivePointerOver=#FFFFFF",
        L"Stroke@ActivePressed=#FFFFFF",
        L"Fill=Transparent",
        L"Width=38",
